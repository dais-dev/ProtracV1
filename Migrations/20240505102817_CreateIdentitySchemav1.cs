...
{
    /// <inheritdoc />
    public partial class CreateIdentitySchemav1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SPMName = table.Column<string>(type: "TEXT", nullable: true),
                    EstimatedProjectCost = table.Column<decimal>(type: "decimal(18, 2)", nullable: false),
                    Duration = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobStartForm", x => x.ProjectId);
                });
